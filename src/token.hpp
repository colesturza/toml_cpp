#ifndef TOML_CPP_TOKEN_HPP
#define TOML_CPP_TOKEN_HPP
...
inline std::string to_string(const TokenType type) {
  switch (type) {
    ...
    case TokenType::TOKEN_KEY: return "KEY";
    ...
    case TokenType::TOKEN_BOOLEAN: return "BOOLEAN";
    case TokenType::TOKEN_OFFSET_DATETIME: return "OFFSET_DATETIME";
    case TokenType::TOKEN_LOCAL_DATETIME: return "LOCAL_DATETIME";
    case TokenType::TOKEN_LOCAL_DATE: return "LOCAL_DATE";
    case TokenType::TOKEN_LOCAL_TIME: return "LOCAL_TIME";
    ...
    case TokenType::TOKEN_LDBRACKET: return "LDBRACKET";
    case TokenType::TOKEN_RDBRACKET: return "RDBRACKET";
